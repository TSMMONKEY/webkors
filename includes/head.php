...
<html class="no-js" lang="zxx">
    <head>
		...
		<meta name="keywords" content="Website Website-Design Theme-Development php html css js Design THemes">
		<meta name="description" content="">
		<meta name='copyright' content=''>
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		
		<!-- Title -->
        <title>Webkors - Best Website Design in South Africa.</title>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="index.html"><img src="/img/logos/webkors-logo.webp" alt="#" style="max-width: 70%;"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
										...
										<ul class="nav menu">
											...
											<li><a href="#">Services <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													...
													<li><a href="404.html">Business Web Design</a></li>
