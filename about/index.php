<?php require "../services/includes/head.php"; ?>
		<!-- End Header Area -->
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="row">
							<!-- News Head -->
							<div class="about-head news-head hero-section">
								<div class="overlay"></div>
								<div class="content">
									<h1 style="font-family: cursive;"><strong>About Webkors</strong></h1>
												...
												<div class="row">
													<div class="col-lg-4 col-md-4 col-12">
														<div class="single-image text-left">
															<img src="../services/img/essential-web.png" alt="#">
													...
													<div class="col-lg-4 col-md-4 col-12">
														<div class="single-image text-left">
															<img src="../services/img/Business-Boost-Package.png" alt="#">
													...
													<div class="col-lg-4 col-md-4 col-12">
														<div class="single-image text-left">
															<img src="../services/img/Everything-in-Business-Boost-Package.png" alt="#">
									...
									<!-- <div class="blog-comments">
										...
										<div class="comments-body"> -->
											...
											<!-- <div class="single-comments">
												<div class="main">
													<div class="head">
														<img src="../services/img/author1.jpg" alt="#"/>
													</div>
													<div class="body">
														<h4>Afsana Mimi</h4>
											...
											<!--<div class="single-comments left">
												<div class="main">
													<div class="head">
														<img src="../services/img/author2.jpg" alt="#"/>
													</div>
													<div class="body">
														<h4>Naimur Rahman</h4>
														<div class="comment-meta"><span class="meta"><i class="fa fa-calendar"></i>March 05, 2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span></div>
											...
											<!--<div class="single-comments">
												<div class="main">
													<div class="head">
														<img src="../services/img/author3.jpg" alt="#"/>
													</div>
													<div class="body">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="section-title mb-0">
													...
													<img src="../services/img/Animation - 1705474709288.gif" alt="#">
												</div>
											</div>
										</div>
										<div class="row">
											...
											<!-- <div class="col-lg-6 col-md-12 ">
												<div class="appointment-image">
													<img src="../services/img/contact-img.png" alt="#">
												</div>
											</div> -->
										</div>
									</div>
									...
									<div class="row mt-5">
										<div class="col-lg-4 col-md-6 col-12">
											...
											<div class="single-news">
												<div class="news-head">
													<img src="../services/img/AdobeStock_686707326_Preview.jpeg" alt="#">
												</div>
												<div class="news-body">
										...
										<div class="col-lg-4 col-md-6 col-12">
											...
											<div class="single-news">
												<div class="news-head">
													<img src="../services/img/AdobeStock_426720359_Preview.jpeg" alt="#">
												</div>
												<div class="news-body">
													<div class="news-content">
														<div class="date">16 January, 2024</div>
										...
										<div class="col-lg-4 col-md-6 col-12">
											...
											<div class="single-news">
												<div class="news-head">
													<img src="../services/img/AdobeStock_660454827_Preview.jpeg" alt="#">
												</div>
												<div class="news-body">
													<div class="news-content">
